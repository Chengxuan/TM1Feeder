...
var PEG = (function (undefined) {
    ...
    modules.define("utils", function (module, require) {
        var utils = {
            ...
            pluck: function (array, key) {
                return utils.map(array, function (e) {
                    return e[key];
                });
            },
            ...
            findRuleByName: function (ast, name) {
                return utils.find(ast.rules, function (r) {
                    return r.name === name;
                });
            },

            indexOfRuleByName: function (ast, name) {
                return utils.indexOf(ast.rules, function (r) {
                    return r.name === name;
                });
            }
        };
            ...
            function parse(input) {
                var options = arguments.length > 1 ? arguments[1] : {},
                    ...
                    peg$c95 = function (inverted, parts, flags) {
                        var partsConverted = utils.map(parts, function (part) {
                            return part.data;
                        });
                        var rawText = "["
                            + (inverted !== null ? inverted : "")
                            + utils.map(parts, function (part) {
                                return part.rawText;
                            }).join("")
                            + "]"
                            + (flags !== null ? flags : "");
    ...
    modules.define("compiler/passes/generate-bytecode", function (module, require) {
        ...
        module.exports = function (ast) {
            ...
            function addConst(value) {
                var index = utils.indexOf(consts, function (c) {
                    return c === value;
                });
            ...
            function buildCall(functionIndex, delta, env, sp) {
                var params = utils.map(utils.values(env), function (p) {
                    return sp - p;
                });
            ...
            if (options.optimize === "size") {
                startRuleIndices = '{ '
                    + utils.map(
                        ...
                        function (r) {
                            return r + ': ' + utils.indexOfRuleByName(ast, r);
                        }
                    ).join(', ')
                    + ' }';
        ...
        module.exports = function (ast, options) {
            ...
            function replaceRuleRefs(ast, from, to) {
                ...
                var replace = utils.buildNodeVisitor({
                    ...
                    rule_ref: function (node, from, to) {
                        if (node.name === from) {
                            node.name = to;
                        }
                    },
    ...
    modules.define("compiler/passes/report-missing-rules", function (module, require) {
        ...
        module.exports = function (ast) {
            ...
            function checkSubnodes(propertyName) {
                return function (node) {
                    utils.each(node[propertyName], check);
                };
            }
